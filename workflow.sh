...
echo "#=====================================================================" | tee -a "${outfile}"
echo "# 0. Data & software                                                  " | tee -a "${outfile}"
echo "#=====================================================================" | tee -a "${outfile}"
# data
echo "data to work with:" | tee -a "${outfile}"
du -csh chr6p_samples/* chr6p_genomes/* chr6p_annotations/* | tee -a "${outfile}"
# software
...
do
	for sample_name in GUP-1_6p GUP-3_6p
	do
    	echo "map ${sample_name} on ${genome_name}" | tee -a "../${outfile}"
...
echo "#===================================================================== " | tee -a "${outfile}"
echo "# Data: initial + generated                                            " | tee -a "${outfile}"
echo "#===================================================================== " | tee -a "${outfile}"
du -csh chr6p_*/* | tee -a "${outfile}"
